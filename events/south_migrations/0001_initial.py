...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        m2m_table_name = db.shorten_name(u'events_event_location')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('event', models.ForeignKey(orm[u'events.event'], null=False)),
            ('location', models.ForeignKey(orm[u'events.location'], null=False))
        ))
        ...
        m2m_table_name = db.shorten_name(u'events_event_tags')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('event', models.ForeignKey(orm[u'events.event'], null=False)),
            ('tag', models.ForeignKey(orm[u'events.tag'], null=False))
        ))
    ...
    def backwards(self, orm):
        ...
        db.delete_table(db.shorten_name(u'events_event_location'))
        ...
        db.delete_table(db.shorten_name(u'events_event_tags'))
    ...
    models = {
        ...
        u'events.event': {
            ...
            'categories': ('django.db.models.fields.related.ManyToManyField', [], {'to': u"orm['events.Category']", 'symmetrical': 'False', 'blank': 'True'}),
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'location': ('django.db.models.fields.related.ManyToManyField', [], {'to': u"orm['events.Location']", 'symmetrical': 'False', 'blank': 'True'}),
            'repeat': ('django.db.models.fields.CharField', [], {'default': "'NEVER'", 'max_length': '15'}),
            'start_date': ('django.db.models.fields.DateTimeField', [], {}),
            'tags': ('django.db.models.fields.related.ManyToManyField', [], {'to': u"orm['events.Tag']", 'symmetrical': 'False', 'blank': 'True'}),
            'title': ('django.db.models.fields.CharField', [], {'max_length': '255'})
        },
        u'events.location': {
