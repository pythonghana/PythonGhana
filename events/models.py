...
class Event(models.Model):
    ...
    start_date = models.DateTimeField(verbose_name=_("start date"), help_text='mm/dd/yyyy')
    end_date = models.DateTimeField(_("end date"), help_text='mm/dd/yyyy')
    ...
    url = models.URLField(default='', help_text='Link to Event Website', blank=True,)
    facebook_url = models.URLField(default='', help_text='Link to Facebook Page', blank=True,)
    twitter_url = models.URLField(default='', help_text='Link to Twitter Handle', blank=True,)
    register_url = models.URLField(default='', help_text='Link for Registrations, if any', blank=True,)
