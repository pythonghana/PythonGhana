...
#            self.event.occurrence.append(self.day)
    ...
    def formatmonth(self, theyear, themonth, withyear=True, net=None, qs=None, template='events/partials/calendar/month_table.html'):
...
class EventCalendar(GenericCalendar):
    ...
    def formatday(
            self, day, weekday,
            day_template='events/partials/calendar/day_cell.html',
            noday_template='events/partials/calendar/day_noday_cell.html',
            popover_template='events/partials/calendar/popover.html',
            ):
...
class MiniEventCalendar(EventCalendar):
    ...
    def formatday(self, day, weekday):
        ...
        return super(MiniEventCalendar, self).formatday(
            day, weekday,
            day_template='events/partials/calendar/mini_day_cell.html',
            popover_template='events/partials/calendar/mini_popover.html',
        )
